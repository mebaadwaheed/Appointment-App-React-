import MagnifyPNG from '../assets/magnifying-glass 1 (1).png';
import VerifiedPNG from '../assets/verified 1 (1).png';
import AppointmentPNG from '../assets/online-appointment 1 (1).png';
import SolutionPNG from '../assets/solution 1 (1).png';
